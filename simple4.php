...
<html>
    ...
    <div class="topnav" id="menu23">
       ...
       <a  href="add_categorie.php">Adaugare Categorie</a>
        ...
        <a class="active" href="simple4.php">Vanzari</a>
        <a href="simple5.php">Stocuri&Teritorii</a>
</div>
       
<br>
			<br>
			<b>Afisati angajatul cu cele mai multe vanzari si clientii care au cumparat:</b>
			<br>
			<br>
            <form method="post">
            ...
            {   
                ...
                $sql = "SELECT angajat.angajatid, angajat.nume, angajat.prenume, COUNT(comanda.comandaid) AS numar_comenzi
                FROM angajat
                JOIN comanda ON angajat.angajatid = comanda.angajatid
                GROUP BY angajat.angajatid
            ...
            {   
                ...
                $sql = "SELECT DISTINCT client.clientid, client.nume, client.prenume
                FROM client
                JOIN comanda ON client.clientid = comanda.clientid;
                ";
