...
<html>
    ...
    <div class="topnav" id="menu23">
       ...
       <a  href="add_categorie.php">Adaugare Categorie</a>
        ...
        <a class="active" href="simple.php">Prod-Distribuitor</a>
        ...
        <br>
			<br>
			<b>Afisati produsele livrate de un anumit distribuitor:</b>
			<br>
			<br>
            <form method="post">
            ...
            {   
                ...
                $sql = "SELECT produsID, nume_prod
                FROM produse
                JOIN distribuitor ON produse.distribuitorID = distribuitor.distribuitorID
                WHERE distribuitor.companie = '$companie'";
